...
output_path = r"D:/synchronize folder/OneDrive - my.swjtu.edu.cn/文件/学业发展中心/统计/年级/统计结果 区间长度" + \
    str(rang_leng) + "/"  # 输出数据路径
output_file_name = r"软件2018级"  # 输出文件名
folder_and_file = [
    # r"电科(微电)/", [
    #     r"电科(微电)2014-01班", r"电科(微电)2014-02班",
    #     r"电科(微电)2015-01班", r"电科(微电)2015-02班",
    #     r"电科(微电)2016-01班", r"电科(微电)2016-02班",
    #     r"电科(微电)2017-01班", r"电科(微电)2017-02班",
    #     r"电科(微电)2018-01班", r"电科(微电)2018-02班",
    # ],
    ...
    # r"计算机类/", [
    #     r"计算机类2019-01班", r"计算机类2019-02班", r"计算机类2019-03班", r"计算机类2019-04班", r"计算机类2019-05班", r"计算机类2019-06班",
    # ],
    ...
    # r"软件/", [
    # r"软件2014-01班", r"软件2014-02班", r"软件2014-03班", r"软件2014-04班",
    # r"软件2015-01班", r"软件2015-02班", r"软件2015-03班",
    # r"软件2016-01班", r"软件2016-02班",
    # r"软件2017-01班", r"软件2017-02班",
    # r"软件2018-01班", r"软件2018-02班", r"软件2018-03班",
    # ],

    # r"通信/", [
    #     r"通信2014-01班", r"通信2014-02班", r"通信2014-03班", r"通信2014-04班", r"通信2014-05班", r"通信2014-06班",
    ...
    # r"网络/", [
    # r"网络2016-01班", r"网络2016-02班", r"网络2016-03班", r"网络2016-04班", r"网络2016-05班", r"网络2016-06班",
    # r"网络2017-01班", r"网络2017-02班", r"网络2017-03班", r"网络2017-04班", r"网络2017-05班", r"网络2017-06班",
    # r"网络2018-01班", r"网络2018-02班", r"网络2018-03班", r"网络2018-04班", r"网络2018-05班",
    # ],
    ...
    # r"信息类/", [
    #     r"信息类2019-01班", r"信息类2019-02班", r"信息类2019-03班", r"信息类2019-04班", r"信息类2019-05班", r"信息类2019-06班",
    # ],

    # r"自动/", [
    #     r"自动2014-01班", r"自动2014-02班",
    #     r"自动2015-01班", r"自动2015-02班",
    #     r"自动2016-01班", r"自动2016-02班",
    #     r"自动2017-01班", r"自动2017-02班",
    #     r"自动2018-01班", r"自动2018-02班",
    #     r"自动2019-01班", r"自动2019-02班", r"自动2019-03班", r"自动2019-04班", r"自动2019-05班", r"自动2019-06班",
    # ],
